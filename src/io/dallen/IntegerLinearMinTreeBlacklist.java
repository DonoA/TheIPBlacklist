//package io.dallen;
//
//public class IntegerLinearMinTreeBlacklist implements IPBlacklist {
//
//    private byte[] tree  = new byte[0];
//
//    private byte[] childBlockSize = new byte[] { 0 };
//
//    @Override
//    public void addIP(String ip) {
//        String[] bits = ip.split("\\.");
//        byte b;
//        int childWidth = childBlockSize[0];
//        int childStart = 0;
//
//        for(int i = 0; i < bits.length; i++) {
//            b = (byte) Integer.parseInt(bits[i]);
//            int p = scanFor(tree, b, childStart, childWidth);
//            if(p == -1) {
